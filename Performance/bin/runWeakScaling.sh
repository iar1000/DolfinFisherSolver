...
bsub -o "weak-600-1" -W 24:00 -R "rusage[scratch=10000, mem=3000]" -n 1 mpirun ./Performance-FisherSolver --name "weakscaling-600k" --meshname "lh-white-hull-flood-0-1-merge-5-dof-600k.h5" --type "$TYPE" --newton_tol "$TOL" --krylovnonzero "$KRYLNONZERO"
bsub -o "weak-600-8" -W 24:00 -R "rusage[scratch=10000, mem=3000]" -n 8 mpirun ./Performance-FisherSolver --name "weakscaling-600k" --meshname "lh-white-hull-flood-0-1-merge-5-dof-4700k.h5" --type "$TYPE" --newton_tol "$TOL" --krylovnonzero "$KRYLNONZERO"
bsub -o "weak-600-60" -W 24:00 -R "rusage[scratch=10000, mem=3000]" -n 60 mpirun ./Performance-FisherSolver --name "weakscaling-600k" --meshname "lh-white-hull-flood-0-1-merge-5-dof-37000k.h5" --type "$TYPE" --newton_tol "$TOL" --krylovnonzero "$KRYLNONZERO"
